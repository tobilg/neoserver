...
func skipIfNoUpdateSequence(t *testing.T) {
	t.Helper()
	if testCtx.Capabilities == nil || testCtx.Capabilities.UpdateSequence == "" {
		t.Skip("No UpdateSequence advertised in capabilities")
	}
}
